...
- [Performance, Fault Tolerance & Deployment](#performance-fault-tolerance--deployment)
  ...
  - [Understanding Sharding (Horizontal Scaling)](#understanding-sharding-horizontal-scaling)
  - [Deploying a MongoDB Server](#deploying-a-mongodb-server)
  - [Using MongoDB Atlas](#using-mongodb-atlas)
  - [Backups and Setting Alerts in MongoDB Atlas](#backups-and-setting-alerts-in-mongodb-atlas)
  - [Connecting to an Atlas Cluster](#connecting-to-an-atlas-cluster)
  - [Performance, Fault Tolerance & Deployment — Summary](#performance-fault-tolerance--deployment--summary)
- [Transactions](#transactions)
  - [Introduction](#introduction-2)
  - [What are Transactions?](#what-are-transactions)
  - [A Typical Use Case](#a-typical-use-case)
  - [How Does a Transaction Work?](#how-does-a-transaction-work)
...
|---|---|---|
| **Authentication** | *Who are you?* | Username + password login against a database |
| **Authorization** | *What can you do?* | Roles assigned to the authenticated user |
...
#### *Enabling Authentication — `--auth` flag*
...
#### *Creating an Application User on a Specific Database*
...
#### *Adding Access to a Second Database*
...
#### *Starting mongod with TLS Required*
...
#### *MongoDB Enterprise — Storage Encryption*
...
#### *Application-Level Encryption — Developer Responsibility*
